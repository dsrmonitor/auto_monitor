...
public class VehiclesDTO {
    ...
    private Double last_west_coord;
    private Double last_south_coord;
	...
	public Double getLast_west_coord() {
        return last_west_coord;
    }

    public void setLast_west_coord(Double last_west_coord) {
        this.last_west_coord = last_west_coord;
    }
	
	public Double getLast_south_coord() {
        return last_south_coord;
    }

    public void setLast_south_coord(Double last_south_coord) {
        this.last_south_coord = last_south_coord;
    }
